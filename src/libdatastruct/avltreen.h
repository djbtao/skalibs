...
#define AVLTREEN_ZERO { .x = GENSET_ZERO, .root = (unsigned int)-1, .cmp = 0, .external = 0 }
...
extern void avltreen_init (avltreen_ref, avlnode_ref, unsigned int *, unsigned int, uintcmpfunc_t_ref, void *) ;
